...
public class CommunityMessageService {
    ...
    public CommunityMessageDTO saveMessage(Integer communityId, shareyourstory.domain.user.model.User user, String text) {
        ...
        CommunityMessageDTO broadcastDto = toDto(savedMessage, false);
        webSocketService.broadcastCommunityMessage(String.valueOf(communityId), broadcastDto);

        return toDto(savedMessage, true);
    }
